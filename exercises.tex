...
\end{exer}
\begin{proof}
If \(x\in\cond{P}\), then \(x\)~is a limit point of~\(P\), so \(x\in P\) by closure of~\(P\). Conversely if \(x\in P\sect(a,b)\), then \(\card{P\sect(a,b)}=\cc\) (Exercise~4.8), so \(x\in\cond{P}\).
\end{proof}
